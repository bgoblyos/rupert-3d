...
/* package rupert-3d-0.1.0.0 */
#ifndef VERSION_rupert_3d
#define VERSION_rupert_3d "0.1.0.0"
#endif /* VERSION_rupert_3d */
#ifndef MIN_VERSION_rupert_3d
#define MIN_VERSION_rupert_3d(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rupert_3d */

/* package AC-Random-0.1 */
#ifndef VERSION_AC_Random
#define VERSION_AC_Random "0.1"
#endif /* VERSION_AC_Random */
#ifndef MIN_VERSION_AC_Random
#define MIN_VERSION_AC_Random(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AC_Random */
...
#define CURRENT_COMPONENT_ID "rupert-3d-0.1.0.0-inplace-rupert-3d"
